...
public class Tab1 extends Fragment {
    ...
    class JSONrequest extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            final JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "http://api.rottentomatoes.com/api/public/v1.0/movies.json?apikey=54wzfswsa4qmjg8hjwa64d4c&q=Hello&page_limit=10", "NULL", new Response.Listener<JSONObject>() {
                @Override
