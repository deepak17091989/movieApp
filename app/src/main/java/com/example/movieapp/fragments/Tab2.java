...
import com.example.movieapp.adapters.Upcoming;
...
public class Tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.e("hello", "hello"+ movieList);
        movieAdapter = new Upcoming(getActivity(),movieList);
        layout = (LinearLayout) v.findViewById(R.id.progressbar_view);
        new JSONrequest().execute();
        Log.e("tag21", "after execution" + movieList);
    ...
    class JSONrequest extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            final JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "http://api.rottentomatoes.com/api/public/v1.0/lists/movies/box_office.json?apikey=54wzfswsa4qmjg8hjwa64d4c&limit=50", "NULL", new Response.Listener<JSONObject>() {
                @Override
